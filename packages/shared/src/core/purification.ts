import type { LyricInfo, Line } from '@root/types'
import type { CommonPurificationOptions, DeepRequired } from '@root/types'
import type { ContextCommon, MusicInfoProps } from '@root/types'

import { PURIFICATION_MATCH_MODE, DEFAULT_PURIFICATION_RULES, DEFAULT_PURIFICATION_RULES_QUICK_KEYWORDS } from '@root/constants'
